...
Telegram-бот для расписания занятий в университетах. Первый поддерживаемый вуз — [РязГМУ](https://www.rzgmu.ru).

## Возможности

- Выбор университета → специальности → курса → группы через inline-кнопки
